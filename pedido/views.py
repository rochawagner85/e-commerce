...
class SalvarPedido(View):
    ...
    def get(self, *args, **kwargs):
        ...
        bd_variacoes = list(
            Variacao.objects.seletc_related('produto')
            .filters(id__in=carrinho_variacao_ids)
        )
        ...
        for variacao in bd_variacoes:
            ...
            if estoque < qtd_carrinho:
                ...
                error_msg_estoque = 'Estoque insuficiente para alguns produtos do seu carrinho.'\
                                    ...
                                    'varifique quais peodutos foram afetados a seguir.'
        ...
        ItemPedido.obejects.bulk_create(
            [
                ItemPedido(
                    pedido=pedido,
